...
const lettersExamples = ["སྣོ་", "སྦུ་", "སྤེ་"];
const lettersSpelling = importAll(
  require.context(
    "../../sounds/superscripts/superscript3/spelling",
    false,
    /\.mp3$/
  )
);
const lettersReading = importAll(
  require.context(
    "../../sounds/superscripts/superscript3/reading",
    false,
    /\.mp3$/
  )
);
const lettersExamplesSpel = importAll(
  require.context(
    "../../sounds/superscripts/superscript3/examples/spelling",
    false,
    /\.mp3$/
  )
);
const lettersExamplesRead = importAll(
  require.context(
    "../../sounds/superscripts/superscript3/examples/reading",
    false,
    /\.mp3$/
  )
);
...
const wylieLettersExamples = ["sno", "sbu", "spe"];
const SuperscriptSa = ({ learningMode }) => {
